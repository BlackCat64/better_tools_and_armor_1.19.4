...
import net.mcreator.bettertoolsandarmor.item.FlameEffectItem;
...
import net.mcreator.bettertoolsandarmor.item.ElectricEffectItem;
...
public class BetterToolsModItems {
	...
	public static final RegistryObject<Item> FLAME_EFFECT = REGISTRY.register("flame_effect", () -> new FlameEffectItem());
	public static final RegistryObject<Item> ICE_EFFECT = REGISTRY.register("ice_effect", () -> new IceEffectItem());
	public static final RegistryObject<Item> ELECTRIC_EFFECT = REGISTRY.register("electric_effect", () -> new ElectricEffectItem());

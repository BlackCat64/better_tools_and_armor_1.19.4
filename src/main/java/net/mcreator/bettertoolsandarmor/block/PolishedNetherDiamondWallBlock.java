...
public class PolishedNetherDiamondWallBlock extends WallBlock {
	public PolishedNetherDiamondWallBlock() {
		super(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.CRIMSON_NYLIUM).sound(SoundType.METAL).strength(2.5f, 6f).requiresCorrectToolForDrops().dynamicShape());
	}

...
public class LightPolishedEmeraldTrapdoorBlock extends TrapDoorBlock {
	public LightPolishedEmeraldTrapdoorBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.EMERALD).sound(SoundType.METAL).strength(2.5f, 6f).requiresCorrectToolForDrops().dynamicShape(), BlockSetType.STONE);
	}

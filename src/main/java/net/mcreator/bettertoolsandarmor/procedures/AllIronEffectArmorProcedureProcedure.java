...
public class AllIronEffectArmorProcedureProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (!(entity instanceof ServerPlayer _plr0 && _plr0.level instanceof ServerLevel
				&& _plr0.getAdvancements().getOrStartProgress(_plr0.server.getAdvancements().getAdvancement(new ResourceLocation("better_tools:all_iron_effect_armor_adv"))).isDone())) {

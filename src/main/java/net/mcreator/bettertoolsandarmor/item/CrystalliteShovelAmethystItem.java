...
import net.mcreator.bettertoolsandarmor.procedures.CrystalliteShovelAmethystChestLocationProcedure;
...
public class CrystalliteShovelAmethystItem extends ShovelItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		CrystalliteShovelAmethystChestLocationProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
